...
import { makeMonthlyColumnChart, makeLineChart, makePieChart } from '../../../shared/utils/multiple-charts-helper';
import { BehaviorSubject, combineLatest, distinctUntilChanged, map, Observable, shareReplay, Subject, switchMap } from 'rxjs';
import { ExpenseService } from '../../../services/ExpenseService/expense.service';
import { ExpenseList, FilterParams } from '../../../interface/expense.interface';
import { CommonModule, DecimalPipe } from '@angular/common';
import { calcChangePct, calcKPIs, getPrevMonth } from '../../../shared/utils/calculate-expense.helper';
import { mainColorPieChart } from '../../../common/common-list';

@Component({
  selector: 'app-report',
  standalone: true,
  imports: [HeaderComponent, FilterComponent, MatIcon, NgApexchartsModule, DecimalPipe, CommonModule],
...
export class ReportComponent{
  ...
  month$ = this.filter$.pipe(
    switchMap(p => this.expenseService.getExpenseList({ year: p.year, month: p.month })),
    shareReplay(1)
  );
