...
import { ExpenseList, PaidMethodEnum } from '../../../interface/expense.interface';
...
describe('ExpenseListComponent', () => {
  ...
  beforeEach(async () => {
    ...
    .overrideProvider(SettingsServiceService, { useValue: mockSettingsService }) 
  ...
  it('Should redner expense rows from service data', async () => {
    ...
    const data: ExpenseList[] = [
      { id: '1', date: new Date('2025-09-11T00:00:00.000Z'), description: "test", purpose: "test", paid: PaidMethodEnum.CASH, for: "Me", amount: 100000, createdAt: new Date('2025-09-11T00:00:00.000Z') },
      { id: '2', date: new Date('2025-09-12T00:00:00.000Z'), description: "test", purpose: "test", paid: PaidMethodEnum.CASH, for: "Me", amount: 105000, createdAt: new Date('2025-09-12T00:00:00.000Z') }
    ];
